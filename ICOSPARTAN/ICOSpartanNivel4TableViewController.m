//
//  ICOSpartanNivel4TableViewController.m
//  ICOSPARTAN
//
...
@interface ICOSpartanNivel4TableViewController ()

@end

@implementation ICOSpartanNivel4TableViewController

- (void)viewDidLoad {
    [super viewDidLoad];
    
    NSString *path = [[NSBundle mainBundle] pathForResource:@"spartanLevel4"
                                                     ofType:@"plist"];
...
-(void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    ICODetailSpartanNivel4ViewController *detailSpartanNivel1 = [self.storyboard instantiateViewControllerWithIdentifier:@"DetalleSpartanNivel4"];
    ...
    detailSpartanNivel1.imageView = image;
