//
//  ICOSpartanNivel2TableViewController.m
//  ICOSPARTAN
//
...
#import "ICODetailSpartanNivel2ViewController.h"

@interface ICOSpartanNivel2TableViewController ()

@end

@implementation ICOSpartanNivel2TableViewController

- (void)viewDidLoad {
    [super viewDidLoad];
    
    
    NSString *path = [[NSBundle mainBundle] pathForResource:@"spartanLevel2"
                                                     ofType:@"plist"];
...
-(void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    ICODetailSpartanNivel2ViewController *detailSpartanNivel1 = [self.storyboard instantiateViewControllerWithIdentifier:@"DetalleSpartanNivel2"];
