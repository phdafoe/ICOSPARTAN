...
- (IBAction)makeGroupButt:(id)sender {
    ...
    ICONavigationViewController *navController = [[ICONavigationViewController alloc]initWithRootViewController:chatGroupVC];
...
- (void)tableView:(UITableView *)tableView commitEditingStyle:(UITableViewCellEditingStyle)editingStyle forRowAtIndexPath:(NSIndexPath *)indexPath {
	...
	[_messagesTable deleteRowsAtIndexPaths:@[indexPath] withRowAnimation:UITableViewRowAnimationFade];
