//
//  ICOSpartanNivel3TableViewController.m
//  ICOSPARTAN
//
...
#import "CustomCell.h"
#import "ICODetailSpartanNivel3ViewController.h"

@interface ICOSpartanNivel3TableViewController ()

@end

@implementation ICOSpartanNivel3TableViewController

- (void)viewDidLoad {
    [super viewDidLoad];
    
    NSString *path = [[NSBundle mainBundle] pathForResource:@"spartanLevel3"
                                                     ofType:@"plist"];
